...
Скриншоты в README сгенерированы `scripts/make_screenshots.py` (Playwright + мок-ответы API,
без реального бэкенда) — запустите заново после визуальных изменений в `static/`, чтобы
обновить картинки.
